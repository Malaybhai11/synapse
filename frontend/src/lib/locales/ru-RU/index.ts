export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Synapse недоступен",
  ...
  navigation: {
    ...
    ask: "Запрос",
    modes: "Режимы",
    hypothesisMode: "Режим гипотезы",
    critiqueMode: "Режим критики",
  },
  notebooks: {
    title: "Блокноты",
    newNotebook: "Новый блокнот",
  ...
  settings: {
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Synapse автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Synapse.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Synapse",
    missingRequiredModels: "Отсутствуют необходимые модели: {models}. Synapse может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Synapse.",
