...
Configuration is how you customize Synapse for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running Synapse locally.
