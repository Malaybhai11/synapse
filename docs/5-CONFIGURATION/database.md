...
Synapse uses SurrealDB for its database needs. 

---

## Default Configuration

Synapse should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Synapse (recommended)
...
### DB running in the host machine and Synapse running in Docker
...
### Synapse and Surreal are running on the same machine
