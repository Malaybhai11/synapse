...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Synapse
...
### Synapse in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### Synapse in Docker (Linux)
