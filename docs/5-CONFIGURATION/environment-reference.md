...
Comprehensive list of all environment variables available in Synapse.
...
| `OPEN_NOTEBOOK_PASSWORD` | No | None | Password to protect Synapse instance |
...
| `LANGCHAIN_PROJECT` | No | Synapse | LangSmith project name |
