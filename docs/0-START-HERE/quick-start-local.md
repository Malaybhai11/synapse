...
Get Synapse running with **100% local AI** using Ollama. No cloud API keys needed, completely private.
...
You should see the Synapse interface.
...
4. In Synapse, go to **Settings** → **API Keys**
